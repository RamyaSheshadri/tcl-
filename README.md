...
# 6.Log Parser Script
This script is designed to read a .rpt file, search for specific keywords (such as "VIOLATED"), and print the lines containing those keywords. This is particularly useful for analyzing reports generated by EDA tools.

**Purpose & Importance:**
* **Analyzing Report Files:** Quickly searching for violations or errors in timing or synthesis reports.
* **Automating Log Checks:** Helps automate the process of filtering and extracting important information from large report files.
* **Tool-Specific Logs:** It is commonly used to parse logs from EDA tools like PrimeTime, DC, or Questa, where violations or warnings are crucial for debugging.
